...
{
    return [
        ['id' => 1, 'full_name' => 'Juan Pérez García', 'email' => 'juan.perez@example.com', 'company_id' => 'COM-001', 'password_hash' => '...', 'created_at' => '2020-01-15'],
        ['id' => 2, 'full_name' => 'Ana López', 'email' => 'ana.lopez@example.com', 'company_id' => 'COM-002', 'password_hash' => '...', 'created_at' => '2021-03-22'],
        ['id' => 3, 'full_name' => 'Carlos Sánchez', 'email' => 'carlos.sanchez@example.com', 'company_id' => 'COM-001', 'password_hash' => '...', 'created_at' => '2019-11-10'],
    ];
}

// Verifica si se solicita la salida en formato JSON
